...
export const MOCK_NOTICES = [
  {
    id: 1,
    title: '[공지] 2024년 연말정산 일정 안내',
    date: '2023.12.01',
    important: true,
    content: `
# 2024년 연말정산 일정 안내

임직원 여러분, 안녕하세요. 경영지원팀입니다.
2023년 귀속 연말정산 일정을 아래와 같이 안내드리오니, 기한 내에 서류 제출을 완료해주시기 바랍니다.

### 1. 일정 안내
- **자료 확인 및 다운로드**: 2024.01.15 ~ 2024.01.25 (국세청 홈택스)
- **공제신고서 작성 및 제출**: 2024.01.20 ~ 2024.02.05 (그룹웨어 > HR > 연말정산)
- **최종 세액 확인**: 2024.02.20

### 2. 유의사항
- 기한 내 미제출 시 기본 공제만 적용됩니다.
- 부양가족 변동 사항이 있는 경우, 반드시 등본을 첨부해주시기 바랍니다.

문의사항은 경영지원팀(내선 1234)으로 연락 바랍니다.
감사합니다.
    `
  },
  {
    id: 2,
    title: '[행사] 12월 디자인팀 타운홀 미팅',
    date: '2023.12.05',
    important: false,
    content: `
# 12월 디자인팀 타운홀 미팅
...
안녕하세요, 디자인팀 여러분!
한 해를 마무리하는 12월 타운홀 미팅이 예정되어 있습니다.

### 행사 개요
- **일시**: 2023년 12월 20일 (수) 14:00 ~ 16:00
- **장소**: 3층 대회의실
- **주제**: 2023년 회고 및 2024년 디자인 트렌드 공유
...
많은 참석 부탁드립니다.
  ...
  {
    id: 3,
    title: '[HR] 사내 독감 예방접종 신청',
    date: '2023.11.28',
    important: false,
    content: `
# 사내 독감 예방접종 신청 안내

임직원 건강 관리를 위해 사내 독감 예방접종을 실시합니다.

### 접종 안내
- **대상**: 전 임직원 (희망자)
- **일시**: 2023.12.10 (금) 09:00 ~ 17:00
- **장소**: 2층 의무실
- **비용**: 무료 (회사 전액 지원)

### 신청 방법
- 그룹웨어 > 설문조사 > '독감 예방접종 신청' 참여
- 신청 기한: ~ 2023.12.05(화) 까지
...
건강한 겨울 나시길 바랍니다.
  ...
  {
    id: 4,
    title: '[시스템] 그룹웨어 서버 점검 안내',
    date: '2023.11.25',
    important: false,
    content: `
# 그룹웨어 서버 점검 안내

안정적인 서비스 제공을 위해 정기 서버 점검이 진행될 예정입니다.
점검 시간 동안 그룹웨어 접속이 중단되오니 업무에 참고하시기 바랍니다.

### 점검 일시
- 2023.12.02 (토) 22:00 ~ 12.03 (일) 06:00 (8시간)
